...
'''
uses color in anticipation of having different types of people 
'''
        ...
        if randDir == 0:
            if (0 <= oldX-1 < width-1):
                if board[oldX-1][oldY] == ' ':
                    if board[oldX][oldY] == colored('0','green'):
                        board[oldX-1][oldY] = colored('0','green')
                    elif board[oldX][oldY] == colored('X', 'red'):
                        board[oldX-1][oldY] = colored('X', 'red')
            ...
            if (0 <= oldY-1 < height-1):
                if board[oldX][oldY-1] == ' ':
                    if board[oldX][oldY] == colored('0','green'):
                        board[oldX][oldY-1] = colored('0','green')
                    elif board[oldX][oldY] == colored('X', 'red'):
                        board[oldX][oldY-1] = colored('X', 'red')
