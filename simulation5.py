...
def endBoard(board, width, height, generation, patientZero):
    ...
    board[patientZero[0]][patientZero[1]] = colored('.','white')
    print '\n\nYOUR POPULATION (where green is a healthy person, red is an infected person, and white is the infected patient zero):\n'
    printBoard(board, width, height)
